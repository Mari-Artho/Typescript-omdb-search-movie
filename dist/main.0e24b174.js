...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/models/iService.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Service.prototype.getData = function (useData) {
    getOMDBData(useData);
  ...
  Service.prototype.getMovieData = function (title, useData) {
    getMovieDataFromOMDB(title, useData);
  };

  return Service;
}();

exports.Service = Service; // any means that you return either nothing (void) or anything,
...
var iService_1 = require("./models/iService"); //たけさとがiPadを１人ずつ使いたいから、newを作るみたいな感じだよー。


var service = new iService_1.Service(); //service.getData(logData);
...
function useData(movieInfo) {
  //show title
  document.getElementById("title").innerText = movieInfo.Title; //show director's name
...
},{"./models/iService":"ts/models/iService.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
